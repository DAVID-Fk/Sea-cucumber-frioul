...
par(las=1, mar=c(5,5,1,2), mfrow=c(1,1), bty="n")
boxplot(sedconctot~substring(names(sedconctot), 8, 10), xlab="Experiment", ylab=expression(paste("Fatty acids concentration (mg g d", w^-1, ")")), ylim=c(0,2))
...
#pdf(file="Fig3.pdf", width=7.5, height=6)
